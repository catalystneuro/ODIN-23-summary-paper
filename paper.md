...
The creation and maintenance of what is historically considered a strong training dataset for machine learning, such as MNIST [10.1109/MSP.2012.2211477] in computer vision or GigaSpeech [
https://doi.org/10.48550/arXiv.2106.06909] for speech recognition, is a non-trivial effort by the maintainers to avoid including incorrectly labeled samples. Of course, the sheer homogeneity of data types in these classic examples contributes to their reusability, whereas neurophysiology experiments tend to be specifically designed to heterogeneously answer the particular question of interest to the experimenter. Thankfully, there are common data elements within modalities, such as the fluorescence traces from optical regions of interest or the spike trains sorted from extracellular probes. Other context-dependent data streams such as pose estimation, sensory stimuli, trial structure, optogenetic stimulation, _etc._ may even follow subsets of commonalities such as open field exploration vs. maze navigation or static vs. drifting visual gratings. Still, these behavioral aspects of the experiment are often the hardest part of standardization, and it is the hope that larger-scale efforts such as BEADL [https://doi.org/10.1101/2024.01.08.574597] or HED [https://doi.org/10.3389/fninf.2016.00042] will offer a path towards enhancing reusability.
